...
class TestSimhash(TestCase):
    def test_return_true_when_similar(self):
        ...
        str2 = str(str1)
        self.assertEqual(SimhashComparer.compare(str1, str2), True)

    def test_return_true_when_similar_but_more_new_lines_and_whitespaces(self):
        str1 = """Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        Nulla sed tortor in est facilisis viverra ut quis nisl.
        Morbi at scelerisque quam. Vivamus vitae neque faucibus, cursus ligula vel, eleifend sem.
        In hac habitasse platea dictumst. Etiam gravida massa sit amet ante vehicula, vel volutpat augue varius.
    ...
    def test_return_true_when_similar_but_few_words_changed(self):
        str1 = """Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        Nulla sed tortor in est facilisis viverra ut quis nisl.
        Morbi at scelerisque quam. Vivamus vitae neque faucibus, cursus ligula vel, eleifend sem.
        In hac habitasse platea dictumst. Etiam gravida massa sit amet ante vehicula, vel volutpat augue varius.
    ...
    def test_return_falsee_when_completely_different(self):
        str1 = """Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        Nulla sed tortor in est facilisis viverra ut quis nisl.
        Morbi at scelerisque quam. Vivamus vitae neque faucibus, cursus ligula vel, eleifend sem.
        In hac habitasse platea dictumst. Etiam gravida massa sit amet ante vehicula, vel volutpat augue varius.
        ...
        self.assertEqual(SimhashComparer.compare(str1, str2), False)
